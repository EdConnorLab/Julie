...
from analyses.single_neuron_analysis import plot_permutation_anova_distribution, plot_permutation_kw_distribution
...
def run_permutation_kruskal_wallis_by_window(df,
                                    ...
                                    plot=False):
    """
    Perform permutation Kruskal-Wallis for each NeuronID and time window combination.
    ...
    for (neuron, win_start, win_end), sub_df in tqdm(grouped_df, desc="Running Permutation Kruskal-Wallis per (Neuron, Window)"):
