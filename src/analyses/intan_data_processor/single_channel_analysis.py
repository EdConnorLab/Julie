"""
single_channel_analysis.py — Channel-level raster plots and spike-rate histograms.
"""
...
def _raster_save_path(date, round_no, channel):
    ...
    save_dir = "/home/connorlab/Documents/GitHub/Julie/Cortana/mixed_manual_raster_plots/"
