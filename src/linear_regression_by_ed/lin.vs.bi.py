...
maxbsq = []    #-dimensional list of rsquared max for each cell across behaviors and source monkeys
for i in range (0, ncells):
    maxbsq.append(0.0)

max_bi_beh = []    #-dimensional list of rsquared max for each cell across behaviors and source monkeys
for i in range (0, ncells):
    max_bi_beh.append(0)

max_bi_mnk = []    #-dimensional list of rsquared max for each cell across behaviors and source monkeys
nxt_bi_mnk = []
for i in range (0, ncells):
    max_bi_mnk.append(0)
    nxt_bi_mnk.append(0)
...
#for ibehavior in range (1, 2):
    ...
    #for icell in range (0, 1):
        ...
        bisquared = r2_score(y, ypred)
        
        if (bisquared > maxbsq[icell]):
            maxbsq[icell] = bisquared
            max_bi_beh[icell] = ibehavior
            max_bi_mnk[icell] = maxmonkey
...
for icell in range(0, ncells):
    ...
    print('maxbsq = ', maxbsq[icell], 'max_bi_beh =', max_bi_beh[icell], 'max_bi_mnk = ', max_bi_mnk[icell], 'nxt_bi_mnk =', nxt_bi_mnk[icell])
