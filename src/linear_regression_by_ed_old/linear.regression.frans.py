...
trialresponses = pd.read_excel(
    '/Users/charlesconnor/Dropbox/grants/social.memory/selected_cells_time_windowed/BestFrans/combined_bestfrans_spike_count_time_windowed.xlsx')
...
affiliationtomatrix = [[0, 17, 8, 17, 15], [18, 0, 7, 17, 27], [10, 5, 0, 20, 13], [13, 6, 22, 0, 13],
                       [10, 28, 5, 11, 0]]
...
cellnames = ['11/8 3 1 0 0–250', '10/31 1 22 0–750', '10/27 4 20 0–750', '10/27 4 11 0–750', '10/5 1 4 0–2000',
             '10/4 4 21 2 0–700', '10/4 2 9 1 100–500', '10/4 1 19 3 100–500', '10/3 4 10 2 200–600', '9/28 1 25 2',
             '10/4 4 7', '10/31 2 5 250–750', '11/22 3 28', '11/25 2 1', '11/27 3 2', '11/27 3 17']
ncells = 16
...
for icell in range(0, ncells):
    for sourcemonkey in range(0, nmonkeys):
        ...
        if (Rsquared[ibehavior][sourcemonkey][icell] > 0.25):
            ...
            print('for cell ', icell, ' = ', cells[icell], ' in response array for source monkey',
                  monkeyname[sourcemonkey], 'Rsquared = ', Rsquared[ibehavior][sourcemonkey][icell])
    ...
    for ibehavior in range(0, nbehaviors):
        for sourcemonkey in range(0, nmonkeys):
            if (siglist[icell][ibehavior][sourcemonkey] > 0):
                print('icell = ', icell, cellnames[icell], behaviornames[ibehavior], monkeyname[sourcemonkey],
                      siglist[icell][ibehavior][sourcemonkey])
...
for sourcemonkey in range(0, nmonkeys):
    for pairmonkey in range(0, nmonkeys):
        print('sourcemonkey ', monkeyname[sourcemonkey], 'pairmonkey ', monkeyname[pairmonkey],
              'sum max Rsquared products', comblist[sourcemonkey][pairmonkey])
