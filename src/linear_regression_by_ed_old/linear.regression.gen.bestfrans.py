...
trial_responses = pd.read_excel(
    '/home/connorlab/Documents/GitHub/Julie/files_for_lin_reg_analysis_by_ed/combined_bestfrans_spike_count_time_windowed.xlsx')
...
affiliation_to_matrix = np.array(
    [[0, 17, 8, 17, 15], [18, 0, 7, 17, 27], [10, 5, 0, 20, 13], [13, 6, 22, 0, 13], [10, 28, 5, 11, 0]])
affiliation_from_matrix = affiliation_to_matrix.T

submission_to_matrix = np.array(
    [[0, 1, 2, 0, 0], [1, 0, 1, 0, 4], [5, 8, 0, 33, 10], [19, 25, 3, 0, 11], [17, 24, 6, 13, 0]])
submission_from_matrix = submission_to_matrix.T

agonism_to_matrix = np.array(
    [[0, 1, 2, 3, 16], [0, 0, 2, 10, 23], [1, 0, 0, 5, 13], [0, 0, 12, 0, 17], [0, 12, 1, 3, 0]])
